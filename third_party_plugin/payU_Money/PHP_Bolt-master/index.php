...
<div class="main">
    ...
    <span><input type="text" id="key" name="key" placeholder="Merchant Key" value="zCwWFMtV" /></span>
    </div>
    
    <div class="dv">
    <span class="text"><label>Merchant Salt:</label></span>
    <span><input type="text" id="salt" name="salt" placeholder="Merchant Salt" value="gnlcUDja5p" /></span>
    </div>
    ...
    <span><input type="text" id="fname" name="fname" placeholder="First Name" value="rajesh Nagar" /></span>
    </div>
    
    <div class="dv">
    <span class="text"><label>Email ID:</label></span>
    <span><input type="text" id="email" name="email" placeholder="Email ID" value="rajeshnagarn@gmail.com" /></span>
    </div>
    
    <div class="dv">
    <span class="text"><label>Mobile/Cell Number:</label></span>
    <span><input type="text" id="mobile" name="mobile" placeholder="Mobile/Cell Number" value="9722041171" /></span>
    </div>

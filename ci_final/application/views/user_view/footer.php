...
<!-- footer -->
			...
			<div class="cpy-right text-center  pt-3">
				...
				<div class="copyrightbottom">
					<p class="text-secondary">© 2018 Alleviating. All rights reserved | Design by
						<a href="http://w3layouts.com" class="text-white"> Raj Nagar.</a>
					</p>
				</div>
    ...
    <!-- //footer -->
    <!-- js -->
    <script src="<?php echo base_url()?>user_public/js/jquery-2.2.3.min.js"></script>
    <!-- //js -->
	<script src="<?php echo base_url()?>user_public/js/minimal-slider.js"></script>
<!-- flexSlider (for testimonials) -->
		<!-- Calendar -->
				<link rel="stylesheet" href="<?php echo base_url()?>user_public/css/jquery-ui.css" />
				<script src="<?php echo base_url()?>user_public/js/jquery-ui.js"></script>
				  <script>
						  $(function() {
	...
	<script defer src="<?php echo base_url()?>user_public/js/jquery.flexslider.js"></script>
	<script>
    ...
    <script src="<?php echo base_url()?>user_public/js/move-top.js"></script>
    <script src="<?php echo base_url()?>user_public/js/easing.js"></script>
    <script>
    ...
    <script src="<?php echo base_url()?>user_public/js/SmoothScroll.min.js"></script>
    <!-- //smooth-scrolling-of-move-up -->
    <!-- Bootstrap core JavaScript
================================================== -->
    <!-- Placed at the end of the document so the pages load faster -->
    <script src="<?php echo base_url()?>user_public/js/bootstrap.js"></script>
</body>
</html>
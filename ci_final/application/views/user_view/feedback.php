    ...
    <div class="agileits-wthree-about py-lg-5">
        ...
        <div class="modal-body">
                    <div class="login px-4 mx-auto mw-100">
                        <h5 class="modal-title text-center text-dark mb-4">Feedback NOW</h5>
                  ...
                  <div class="row">
					...
					<div class="field col-lg-12 col-md-12 col-sm-12 col-xs-12">
					  ...
					  <tr>
						<td> <div class="center"><input type="submit" name="feedback" value="Feedback NOW" class="btn btn-primary"></div>
</td>					</tr>

                  ...
                  <div class="row">
					...
					<div class="field col-lg-12 col-md-12 col-sm-12 col-xs-12">
					  ...
					  <?php
						...
						?>
						<tr>
							<td align="center" colspan="6"><img src="<?php echo base_url()?>user_public/upload/<?php echo $d['file1'];?>" style=" height:100px; width:100px; border-radius:50%;"></td>
						</tr>
						<?php
						}
						?>
						...
						<tr>
							...
							<td align="center"><img src="<?php echo base_url();?>user_public/upload/<?php echo $d['file1'];?>" style=" height:50px; width:50px; border-radius:50%;"></td>

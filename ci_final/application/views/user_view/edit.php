	...
	<form class="form_contant" action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
					...
					<div class="field col-lg-12 col-md-12 col-sm-12 col-xs-12">
					  ...
					  <tr>
					  <td>
					  <input class="form-control" name="unm" placeholder="User Name" type="text" value="<?php echo $fetch[0]['unm']?>" required />
					  </td>
					  </tr>	
					   ...
					   <tr>
						<td>
						<input class="form-control" name="file1"  type="file" value="<?php echo $fetch[0]['file1']?>" />
						<img src="<?php echo base_url();?>user_public/upload/<?php echo $fetch[0]['file1'];?>" style=" height:50px; width:50px; border-radius:50%;">
						</td>
					  </tr>	

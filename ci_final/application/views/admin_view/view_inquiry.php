									...
									?>
                                        ...
                                        <tr>
										   ...
										   <td><?php echo $inq['inq_id'];?></td>
                                            ...
                                            <td>
                                                <a href="delete_inq_id/<?php echo $inq['inq_id'];?>"><img src="<?php echo base_url()?>admin_public/images/delete.png" height="30px" width="30px"></a>
                                            ...
                                            <td>
                                                 ...
                                                 <a href="reply_inq_id/<?php echo $inq['inq_id'];?>"><img src="<?php echo base_url()?>admin_public/images/reply.jpg" height="30px" width="30px"></a>
                                            </td>
											<?php
											}
											?>
